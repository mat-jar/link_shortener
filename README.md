...
Endpoints beginning: `https://linkshortener.eusz.eu/api/v1/`

For example: `https://linkshortener.eusz.eu/api/v1/login` </br> or `https://linkshortener.eusz.eu/api/v1/short_links/show`
...
```
POST https://linkshortener.eusz.eu/api/v1/login
```
...
```
POST https://linkshortener.eusz.eu/api/v1/users
```
...
```
GET https://linkshortener.eusz.eu/api/v1//users
```
...
```
GET https://linkshortener.eusz.eu/api/v1/users/show
```
...
```
PUT https://linkshortener.eusz.eu/api/v1/users
```
...
```
DELETE https://linkshortener.eusz.eu/api/v1/users
```
...
```
POST https://linkshortener.eusz.eu/api/v1/short_links
```
...
```
GET https://linkshortener.eusz.eu/api/v1/short_links
```
...
```
PUT https://linkshortener.eusz.eu/api/v1/short_links
```
...
{
  "short_link": {
    "short_url": "https://linkshortener.eusz.eu/filmy",
  },
  "update_short_link": {
    "slug": "updated-slug"
  }
...
```
DELETE https://linkshortener.eusz.eu/api/v1/short_links
```
...
```
POST https://linkshortener.eusz.eu/api/v1/short_links/show
```
...
```
POST https://linkshortener.eusz.eu/api/v1/short_links/fetch_og_tags
```
